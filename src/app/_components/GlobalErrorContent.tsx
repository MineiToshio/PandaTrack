 ...
 */
export function guessLeadLang(): LangGuess {
...
/**
 * Self-contained body of the catastrophic global-error fallback: inline styles, inline SVG,
 * an inline `<style>` media query for light/dark, and bilingual copy. It carries everything
 * except the `<html>`/`<body>` shell so `global-error.tsx` can render it as the root
 * replacement while the dev harness can mount it under its own minimal root layout. The
 * hardcoded palette and inline i18n are the sanctioned exception documented in ADR 0013.
 */
  ...
  return (
    ...
    >
      ...
      <div role="alert" style={{ maxWidth: 460, textAlign: "center" }}>
        ...
        <hr aria-hidden="true" style={{ border: "none", borderTop: "1px solid var(--ge-divider)", margin: "18px 0" }} />
