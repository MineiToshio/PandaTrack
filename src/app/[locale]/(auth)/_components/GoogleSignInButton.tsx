...
/**
 * Google sign-in CTA. Uses the official multicolor "G" mark — brand colors are
 * fixed and intentionally exempt from theming. Visual: secondary `<Button>`.
 */
export default function GoogleSignInButton({ callbackURL, variant }: GoogleSignInButtonProps) {
  ...
  return (
    <Button type="button" variant="secondary" fullWidth className="gap-2.5" onClick={handleClick}>
