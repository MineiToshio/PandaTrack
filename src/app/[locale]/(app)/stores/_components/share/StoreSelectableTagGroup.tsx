      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "border-border bg-background text-text-body focus-visible:ring-ring inline-flex min-h-10 cursor-pointer items-center gap-1.5 rounded-xl border px-4 text-sm transition focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",
