import { z } from "zod";
import { createStoreShape, refinePrivateOnlyPerson } from "../../../new/_schemas/createStoreSchema";
...
const editStoreBaseSchema = z.object({
  ...
  storeType: createStoreShape.storeType,
...
export const editStoreSchema = editStoreBaseSchema.superRefine(refinePrivateOnlyPerson);
