...
- delivery summary header: store, delivery identifier, shipping date, expected arrival range, status, received date when delivered, cost, currency
...
- Opening a delivery shows its summary header with store, delivery identifier, shipping date, status, cost, currency, and expected arrival range as applicable.
