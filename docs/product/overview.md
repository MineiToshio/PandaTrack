...
- Store domain planning: the product now has a defined store model covering business vs person profiles, public discovery, pending-vs-approved moderation, trust signals, reports, category requests, and a deliberately simple MVP metadata model
