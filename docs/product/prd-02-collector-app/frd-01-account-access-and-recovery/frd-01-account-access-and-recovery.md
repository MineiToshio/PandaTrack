...
- Grace-anchor query helpers: `src/lib/data/auth/userQueries.ts` (`findUserVerificationSnapshot`), `src/lib/data/auth/userMutations.ts` (`clearUnverifiedGraceStartsAt`); verification-marker helpers `src/lib/data/auth/verificationQueries.ts` / `src/lib/data/auth/verificationMutations.ts`
...
- `docs/product/prd-02-collector-app/frd-01-account-access-and-recovery/bp-01-auth-identity-and-recovery-platform/bp-01-auth-identity-and-recovery-platform.md`
