...
# Usage: gen.sh rank-07-club-sensei [take]
# The optional take number keeps every attempt of the same rank side by side in raw/, so a
# retake never overwrites the evidence of what the previous prompt actually produced.
set -u
