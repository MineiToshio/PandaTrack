...
superseded_by: docs/product/prd-01-public-landing/frd-01-pre-release-landing/fdd-01-pre-release-landing.md
---
...
> sign-up** (collector app entry). The waitlist form, success/share state, and the
...
> redesigned landing belongs to the collector app rather than this pre-release FRD —
...
- the auth-first go-live landing belongs to the collector app (PRD-02); the durable design
  record is
...
- `docs/product/prd-01-public-landing/frd-01-pre-release-landing/bp-01-public-landing-conversion/bp-01-public-landing-conversion.md`
