...
| `FilterDrawer`                 | `src/components/core/FilterDrawer.tsx`                               | `sections=[estado, pago, tienda, fecha, fx]`, `onApply`, `onReset` | Panel de filtros. Desktop: sidebar derecha estática. Mobile: `Sheet` desde borde derecho. Secciones en §6.                                                      |
