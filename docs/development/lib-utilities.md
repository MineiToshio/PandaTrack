...
| `src/lib/constants.ts`                                    | Shared app constants (routes, analytics events, contact info, Cloudflare asset routes).                                                                                                                                                    |
...
| `src/lib/styles.ts`                                       | Shared class merging (`cn`) plus canonical gradient class bundles (`TINTED_SURFACE_GRADIENT_STOPS`, `TINTED_SURFACE_GRADIENT_TOP_WASH`) for tinted heroes and section washes.                                                              |
