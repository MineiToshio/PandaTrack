...
| `src/lib/catalog/collectorCountries.ts`                   | Seeded collector-market `COUNTRY_CODES`, primary ISO 4217 currency per country, and allowlist helpers for settings validation.                                                                                                             |
