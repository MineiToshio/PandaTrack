...
adrs:
  ...
  - ADR 0008 (backdrop blur extendido a Sheet mobile — mismo `oklch` calibrado que Modal desktop)
---
...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Backdrop        | `position: fixed; inset: 0; background: oklch(12% 0.010 50 / 0.35); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); z-index: calc(var(--z-sheet) - 1);`                                                                                           | `background: oklch(4% 0.015 265 / 0.62);` (resto igual) | Mismo blur que Modal desktop (ADR 0008 — extendido a mobile). Click en backdrop dismiss si `dismissible`. Fade-in con `--motion-base` `--ease-emphasis`.                               |
